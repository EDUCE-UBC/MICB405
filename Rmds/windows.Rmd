...
-   The easiest way to access the ORCA server on Windows is to open the "Command Prompt" application and type in ssh

-   If you would like to customize the  to [Microsoft Store Windows Terminal website](https://aka.ms/terminal) > click the "Get" button to install the app.
