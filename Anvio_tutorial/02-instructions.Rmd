...
Your analysis will focus on **binning and manual refinement** (which is given in your Canvas group name) and the following questions:


You must include ≥ 3 figures/panels with titles and full captions. These figures can be combined into multi-panel figures if desired. These figures would typically contain the Anvi'o metagenome visualization, an example of a refined bin, and completion and redundancy estimates with taxonomic classification

### Discussion
*750--1000 words*

- Frame your depth's results within a broader discussion of Saanich Inlet and the other depths (Apr 6 discussion)
- Propose expected bins and comment on incomplete bins, and the reasoning behind these results  
- Future directions
